    ...
    >
      <div className="flex items-start gap-5 px-2 mb-5">
        <div
          ...
          className="max-w-[105px] max-h-[105px] rounded-2xl flex items-center justify-center"
        >
          {resumeData.profileInfo.profilePreviewUrl ? (
            ...
            <div
              className="w-[120px] h-[120px] flex items-center justify-center text-5xl rounded-full"
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-8 pt-5 mr-10 pb-5">
          <div>
            <Title text="Professional Summery" color={themeColors[1]} />
